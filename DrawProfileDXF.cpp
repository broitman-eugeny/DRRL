...
extern "C" char ** Read_Profile(FILE *stream);// Читает файл профиля на который указывает stream, открытый в text mode (t).
                   ...
                   double HdopRight_d)              //Высота центра раскрыва дополнительной антенны справа, м
{
   ...
   double Prof_Rel_x_km[2048];//км массив расстояний для высотных отметок рельефа + кривизна земли (м) (Prof_Rel)
   ...
   for(i=0; i<=N_relyef-2;i++)
   {
      //Промежуточные (текущая и следующая) координаты (км) и высотные отметки рельефа (м)
		r1=Profile[13+3*i];
      r2=Profile[13+3*(i+1)];
      x1=Profile[12+3*i];//км, расстояние до начала i-го участка рельефа от станции слева
      x2=Profile[12+3*(i+1)];//км, расстояние до начала i+1-го участка рельефа от станции слева
      k=x1/R;//Относительная координата текущей точки
      y=R*R*1000000./2./a*k*(1.-k);//Кривизна профиля в текущей точке
      Prof_Rel[j]=r1+y;//Высотная отметка рельефа + кривизна земли (м) в начале участка рельефа
      Prof_Rel_x_km[j]=x1;//км, расстояние до начала i-го участка рельефа от станции слева
      for(j=(long)(x1*k_shag)+1; j<=(long)(x2*k_shag)-1; j++)//j-номер шага от станции слева
      {
         Prof_Rel_x_km[j]=(double)j/k_shag;//км, расстояние на j-том шаге от станции слева
      	k=Prof_Rel_x_km[j]/R;//относительная координата на j-том шаге  от станции слева
         y=R*R*1000000./2./a*k*(1.-k);//Кривизна профиля в текущей точке
   ...
   Prof_Rel_x_km[j]=R;//км, расстояние в последней точке
   ...
   {                                                                                                                                               // //
      ...
      {                                                                                                                                            // //
      	vx[l]=X_0_profile+Prof_Rel_x_km[j]*Mashtab_x;                                                                             					  	// //
			vy[l]=Y_0_profile+(Prof_Rel[j]-Hor+Profile[18+3*((int)N_relyef)+i*4])*Mashtab_y;                                                          // //
         l++;                                                       																											// //
      }                                                                                                                                            // //
      vx[l]=X_0_profile+Prof_Rel_x_km[j-1]*Mashtab_x;//Вертикальная линия в конце препятствия                                                    // //
      ...
      {                                                                                                                                            // //
         ...
         {                                                                                                                                         // //
      		vx[0]=X_0_profile+Prof_Rel_x_km[j]*Mashtab_x;                                                                             					// //
				vy[0]=Y_0_profile+(Prof_Rel[j]-Hor)*Mashtab_y;//Основание препятствия                                                                  // //
                                                                                                                                                   // //
            vx[1]=X_0_profile+Prof_Rel_x_km[j]*Mashtab_x;                                                                             					// //
   ...
   {                                                                                                                                               //
      ...
      {                                                                                                                                            //
      	vx[i]=X_0_profile+Prof_Rel_x_km[i]*Mashtab_x;                                                                             						//
      ...
      {                                                                                                                                            //
         l=0;//Индекс точек в массиве вершин кривой                                                                                                //
      	for(i=(int)(Profile[19+3*((int)N_relyef)+(int)N_prep*4+((int)N_voda-1)*2]*k_shag); i<=(int)(R*k_shag); i++)//От конца последнего водного участка
         																														 //до конца профиля     								//
         {                                                                                                                                         //
         	vx[l]=X_0_profile+Prof_Rel_x_km[i]*Mashtab_x;                                                                             					//
